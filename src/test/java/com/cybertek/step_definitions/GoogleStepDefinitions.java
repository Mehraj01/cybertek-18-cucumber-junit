...
public class GoogleStepDefinitions {
    ...
    public void userSearches(String searchValue) {//"<searchValue>"
    ...
    public void userShouldSeeInTheTitle(String expectedInTitle) {//"<expectedTitle>"
    ...
    public void user_should_see_six_links_in_the_footer(List<String>linkStrings) {
       ...
       // System.out.println("linkStrings.size() = " + linkStrings.size());
        ...
        // we already created object in class level
